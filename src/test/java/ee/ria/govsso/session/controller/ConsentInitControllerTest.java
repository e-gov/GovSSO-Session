...
class ConsentInitControllerTest extends BaseTest {
    ...
    void consentInit_WhenAcceptConsentIsSuccessful_RedirectsWithIdTokenWithoutPhone() {
        ...
        HYDRA_MOCK_SERVER.verify(putRequestedFor(urlEqualTo("/admin/oauth2/auth/requests/consent/accept?consent_challenge=" + TEST_CONSENT_CHALLENGE))
                .withRequestBody(containing("{\"id_token\":{\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"initiator\":\"DEFAULT\"}")));
    }
    ...
    void consentInit_WhenAcceptConsentWithRepresenteeListScopeIsSuccessful_RedirectsWithIdTokenWithRepresentees() {
        ...
        HYDRA_MOCK_SERVER.verify(putRequestedFor(urlEqualTo("/admin/oauth2/auth/requests/consent/accept?consent_challenge=" + TEST_CONSENT_CHALLENGE))
                ...
                .withRequestBody(containing("\"access_token\":{\"acr\":\"high\",\"amr\":[\"mID\"],\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"initiator\":\"DEFAULT\",\"auth_time\":1672534800}}")));
    }
    ...
    void consentInit_whenRepresenteeListRequestFails_RepresenteeListIsNotAddedToIdToken() {
        ...
        HYDRA_MOCK_SERVER.verify(putRequestedFor(urlEqualTo("/admin/oauth2/auth/requests/consent/accept?consent_challenge=" + TEST_CONSENT_CHALLENGE))
                .withRequestBody(containing("\"id_token\":{\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"representee_list\":{\"status\":\"" + SERVICE_NOT_AVAILABLE + "\"},\"initiator\":\"DEFAULT\"}"))
                .withRequestBody(containing("\"access_token\":{\"acr\":\"high\",\"amr\":[\"mID\"],\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"initiator\":\"DEFAULT\",\"auth_time\":1672534800}")));
    ...
    void consentInit_whenRepresenteeListIsEmpty_emptyRepresenteeListIsAddedToIdToken() {
        ...
        HYDRA_MOCK_SERVER.verify(putRequestedFor(urlEqualTo("/admin/oauth2/auth/requests/consent/accept?consent_challenge=" + TEST_CONSENT_CHALLENGE))
                .withRequestBody(containing("\"id_token\":{\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"representee_list\":{\"status\":\"" + REPRESENTEE_LIST_CURRENT + "\",\"list\":[]},\"initiator\":\"DEFAULT\"}"))
                .withRequestBody(containing("\"access_token\":{\"acr\":\"high\",\"amr\":[\"mID\"],\"given_name\":\"Eesnimi3\",\"family_name\":\"Perekonnanimi3\",\"birthdate\":\"1961-07-12\",\"initiator\":\"DEFAULT\",\"auth_time\":1672534800}")));
    }
}
