<#--
  Derived from navikt/mock-oauth2-server's MIT-licensed version 6.0.2 login template:
  https://github.com/navikt/mock-oauth2-server/blob/6.0.2/src/main/resources/templates/login.ftl
